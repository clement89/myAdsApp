...
import 'package:myads_app/custom_orientation_player/custom_orientation_player.dart';
import 'package:myads_app/custom_orientation_player/data_manager.dart';
import 'package:myads_app/landscape_player/landscape_player_controls.dart';
...
class WatchPortrait extends StatefulWidget {
  final String videoUrl, VideoId, watchtime, productUrl,rons,surveyid,multiplyId,badgeId;
  WatchPortrait({this.videoUrl, this.VideoId, this.watchtime, this.productUrl, this.rons,this.surveyid,this.multiplyId,this.badgeId});
                        ...
                        onTap: () {
                          if(widget.productUrl!= null){
                            ...
                            Fluttertoast.showToast(
                                msg: "The Buy option is not Available now, pls try again later.",
                    ...
                    InkWell(
                     ...
                     InkWell(
                        onTap: () {
                          ...
                          {
                            Navigator.of(context).push(PageRouteBuilder(
                                pageBuilder: (_, __, ___) => new SurveyScreen(videoId: widget.VideoId)));
                          }else{
                            Fluttertoast.showToast(
                          ...
                          Padding(
                            ...
                            child: ValueListenableBuilder(
                              ...
                              builder:
                                ...
                                print(one.toString());
                                print(two.toString());
                                print(two.difference(one).toString().substring(0, 8));
                ...
                onTap: () async {
                  ...
                  if (await SharedPrefManager.instance
                    ...
                    _watchPortraitProvider.performUpdateBalance(
                        textPosition, textPosition, widget.VideoId,widget.multiplyId,widget.badgeId);
                  }
