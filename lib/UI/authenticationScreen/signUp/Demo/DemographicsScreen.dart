              ...
              children: [
                ...
                Column(
                  ...
                  children: <Widget>[
                    ...
                    //         ),
                    //       ),
                    //       value: _demographicsProvider.getCountryList.first,
                    //       //elevation: 5,
                    //       style: TextStyle(color: Colors.black),
                    //
                    //       items: _demographicsProvider.getCountryList != null
                    //           ? _demographicsProvider.getCountryList
                    //               .map<DropdownMenuItem<CountryList>>(
                    //                   (CountryList value) {
                    ...
                    //       ),
                    //       onChanged: (CountryList value) {
                    //         setState(() {
                    //           _chosenValue = value;
                    //           pin = int.parse(value.pinlength);
                    //         });
                    //         provider.selectedCountry = _chosenValue.toString();
                    //       },
                    //     ),
                    //   ),
                    // ),
