class MyStrings {
  ...
  static const String next = "Confirm";
  static const String reset = "RESET PASSWORD";
  static const String forgotUrl = "The process to reset the password has been sent to your registered email ID. Kindly Check";
  ...
  static const String requestBalance = "REQUEST BALANCE";
  static const String addNewFeedBack = "ADD NEW FEEDBACK";
  static const String systemAdminContent = "System Admin\'s Response to your FeedBack is also  shared to your Registered email id";
  static const String weAreHappy = "We are happy to hear from you";
}
